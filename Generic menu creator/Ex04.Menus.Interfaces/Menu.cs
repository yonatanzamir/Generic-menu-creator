...
{ 
    public abstract class Menu: IOptionObserver
    {
        ...
        void IOptionObserver.ReportOption(MenuItem i_Item)
        {
            i_Item.HandleChosenItem();
        }

        public void AddItemToList(MenuItem i_MenuItem)
        {
            r_MenuItems.Add(i_MenuItem);
            AddMenuAsObserver(i_MenuItem);
        }

        public void AddMenuAsObserver(MenuItem i_MenuItem)
        {
